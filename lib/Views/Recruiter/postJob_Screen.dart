        ...
        appBar: AppBar(
          ...
          body: RefreshIndicator(
            ...
            child: Container(
              ...
              width: size.width,
              height: size.height,
              child: allJobModel == null ? Center(child: CircularProgressIndicator()) :  allJobModel!.data!.length == 0 ? Center(child: Text("No Jobs Found"),) : ListView.builder(
