...
class _DrawerScreenState extends State<DrawerScreen> {
  ...
  Future<void> share() async {
    await FlutterShare.share(
        title: 'Share',
        text: 'Alpha Job Dekho',
        linkUrl: 'https://play.google.com/store/apps/details?id=com.alphaJobDekho',
            ...
            children: [
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    CustomDrawerTile(tileName: 'My Profile', tileIcon: Image.asset(profileIconR, scale: 1.3,color: primaryColor,),onTap: (){Get.to(RecruiterMyProfileScreen());},),
                    CustomDrawerTile(tileName: 'Post Job', tileIcon: Image.asset(postjobIconR, scale: 1.3,color: primaryColor,),onTap: (){Get.to(PostJobScreen());}),
                    CustomDrawerTile(tileName: 'Applied', tileIcon: Image.asset(appliedIconR, scale: 1.3,color: primaryColor,),onTap: (){Get.to(applied_Screen());},),
                    CustomDrawerTile(tileName: 'Change Password', tileIcon: Image.asset(changepasswordIconR, scale: 1.3,color: primaryColor,), onTap: (){Get.to(ChangePasswordScreen());},),
                    CustomDrawerTile(tileName: 'Share App', tileIcon: Image.asset(shareappIconR, scale: 1.3,color: primaryColor,),onTap: (){
                      share();
                    },),
                    ...
                    CustomDrawerTile(tileName: 'Notification', tileIcon: Image.asset(notificationIconR, scale: 1.3,color: primaryColor,),onTap: (){Get.to(NotificationScreen());}),
                    CustomDrawerTile(tileName: 'Contact Us', tileIcon: Image.asset(contactusIconR, scale: 1.3,color: primaryColor,), onTap: (){Get.to(ContactUsScreen());},),
                    CustomDrawerTile(tileName: 'Privacy Policy', tileIcon: Image.asset(privactpolicyIconR, scale: 1.3,color: primaryColor,), onTap: (){Get.to(PrivacyPolicyScreen());},),
                    CustomDrawerTile(tileName: 'Terms & Conditions', tileIcon: Image.asset(termsandconditionIconR, scale: 1.3,color: primaryColor,),onTap: (){Get.to(TermsAndConditionScreen());},),
                    CustomDrawerTile(tileName: 'Sign Out', tileIcon: Image.asset(signoutIconR, scale: 1.3,color: primaryColor,),onTap: (){openLogoutDialog();
                    },),
                  ],
                ),
              )
