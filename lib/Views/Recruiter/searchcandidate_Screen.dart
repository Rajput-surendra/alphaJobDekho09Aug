                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Seeker ID: #${model!.data![i].id}", style: TextStyle(fontWeight: FontWeight.bold),),
                                      Text("Seeker Name: " +  "${model!.data![i].name}".toUpperCase() + " " + "${model!.data![i].surname}".toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold),),
                                      SizedBox(height: 10,),
                                      Row(
                                        children: [
                                          Image.asset('assets/AuthAssets/callicon.png', color: primaryColor, scale: 1.5,),
                                          SizedBox(width: 15,),
                                          Text("${model!.data![i].mno}", style: TextStyle(color: greyColor2),),
                                        ],
                                      ),
                                      SizedBox(height: 05,),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 15,),
                                          Text("${model!.data![i].email}", style: TextStyle(color: greyColor2),),
                                        ],
                                      ),
