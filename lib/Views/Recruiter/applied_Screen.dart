  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
      ...
      body:  Container(
        ...
        child:recruiterAppliedListModel == null ? Center(child: CircularProgressIndicator(),) : recruiterAppliedListModel!.data!.length == 0 ? Center(child:Text("No data to show"),) : ListView.builder(
          shrinkWrap: true,
            itemCount: recruiterAppliedListModel!.data!.length,
            itemBuilder: (c,i){
            if(recruiterAppliedListModel!.data![i].user == null){
