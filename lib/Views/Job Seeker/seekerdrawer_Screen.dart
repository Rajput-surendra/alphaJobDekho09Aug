            ...
            children: [
              ...
              Container(
                ...
                //  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    CustomDrawerTile(tileName: 'My Profile', tileIcon: Image.asset(profileIconJ, scale: 1.3,color:primaryColor),onTap: (){Get.to(SeekerProfileDetailScreen());},),
                    CustomDrawerTile(tileName: 'My Jobs', tileIcon: Image.asset(myjobIconJ, scale: 1.3,color:primaryColor),onTap: (){Get.to(MyJobs_Screen());},),
                    CustomDrawerTile(tileName: 'Applied Jobs', tileIcon: Image.asset(appliedjobIconJ, scale: 1.3,color:primaryColor),onTap: (){Get.to(AppliedJobScreen());},),
                    CustomDrawerTile(tileName: 'Change Password', tileIcon: Image.asset(changepasswordIconJ, scale: 1.3,color:primaryColor), onTap: (){Get.to(ChangePasswordScreen());},),
                    ...
                    CustomDrawerTile(tileName: 'Notification', tileIcon: Image.asset(notificationIconJ, scale: 1.3,color:primaryColor),onTap: (){Get.to(NotificationScreen());}),
                    CustomDrawerTile(tileName: 'Share App', tileIcon: Image.asset(shareappIconJ, scale: 1.3,color:primaryColor),onTap: (){share();},),
                    CustomDrawerTile(tileName: 'Contact Us', tileIcon: Image.asset(contactusIconJ, scale: 1.3,color:primaryColor), onTap: (){Get.to(ContactUsScreen());},),
                    CustomDrawerTile(tileName: 'Privacy Policy', tileIcon: Image.asset(privactpolicyIconJ, scale: 1.3,color:primaryColor), onTap: (){Get.to(PrivacyPolicyScreen());},),
                //  CustomDrawerTile(tileName: 'Support & Help', tileIcon: Image.asset(supportandhelpJ, scale: 1.3,), onTap: (){Get.to(SupportHelpScreen());},),
                    CustomDrawerTile(tileName: 'Terms & Conditions', tileIcon: Image.asset(termsandconditionIconJ, scale: 1.3,color:primaryColor),onTap: (){Get.to(TermsAndConditionScreen());},),
                    CustomDrawerTile(tileName: 'Sign Out', tileIcon: Image.asset(signoutIconJ, scale: 1.3,color:primaryColor), onTap: openLogoutDialog,),
                    SizedBox(height: 30,),
                  ],
                ),
              )
