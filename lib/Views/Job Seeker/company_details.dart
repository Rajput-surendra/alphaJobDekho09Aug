    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title:  Text('Company Details', style: TextStyle(color: whiteColor, fontSize: 18, fontWeight: FontWeight.bold),),
            ),
            body:  Container(
                        ...
                        children: [
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  SizedBox(width: 15,),
                                                  Text("Active Post", style: TextStyle(color: greyColor2),),
                                                ],
                                              ),
                                              SizedBox(height: 05,),
                                              Row(
                          ...
                          Positioned(
                            ...
                            child: Card(
                              ...
                              child: CircleAvatar(
                                radius: 40,
                                child: recruiterDetailModel!.data![0].img == null || recruiterDetailModel!.data![0].img == "" ? Image.asset('assets/companydetailslogo.png', scale: 2,color: primaryColor,) : ClipRRect(borderRadius: BorderRadius.circular(100),child: Image.network("${recruiterDetailModel!.data![0].img}",fit: BoxFit.fill,),) ,
                              ),
                            ),
                          ),
                        ],
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("Company Description", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: primaryColor),),
                                            SizedBox(height: 10,),
                                            Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            height: 15,
                                            width: 15,
                                            child:Image.asset(ruppeeIcon,fit: BoxFit.fill,color: primaryColor,),
                                          ),
                                          SizedBox(width: 10,),
                                          Expanded(
                                            child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            height: 20,
                                            width: 20,
                                            child:Image.asset(experienceIcon,color: primaryColor,),
                                          ),
                                          SizedBox(width: 10,),
                                          Expanded(
                                            child: Container(
                                        ...
                                        Material(
                                          ...
                                          child:Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Image.asset(vacancyIcon, scale: 1.5,color: primaryColor,),
                                                  SizedBox(width: 4,),
                                        ...
                                        Material(
                                          ...
                                          child:Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
                                                  Image.asset(locationIcon,scale: 1.5,color: primaryColor,),
                                                  SizedBox(width: 6,),
                                                  Container(
                                                    // width: 95,
