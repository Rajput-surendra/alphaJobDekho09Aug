...
class _SeekerProfileDetailScreenState extends State<SeekerProfileDetailScreen> {
  ...
  getProfileData()async{
    ...
    print("check here data ${request.fields} and ${ApiPath.baseUrl}seeker_info");
  ...
  intialFunction()async{
    ...
    setState(() {
      ...
      specialization = seekerProfileModel!.data!.specialization == "0" || seekerProfileModel!.data!.specialization == "" || seekerProfileModel!.data!.specialization == null || seekerProfileModel!.data!.specialization == "null"   ? null : seekerProfileModel!.data!.specialization.toString();
      ...
      status = seekerProfileModel!.data!.is_looking == "0" || seekerProfileModel!.data!.is_looking == null  ? "" : seekerProfileModel!.data!.is_looking;
          ...
          child: SingleChildScrollView(
            child: seekerProfileModel == null  || addJobDataModel == null  ? Center(child: CircularProgressIndicator(),) : Column(
              ...
              children: [
                        ...
                        builder: (context){
                          return Container(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Alpha Job Dekho: Take Image From", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15)),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ToggleSwitch(
                      ...
                      initialLabelIndex:status == "0" ? 0 : 1,
                      totalSwitches: 2,
                      labels: ['No', 'Yes'],
                      radiusStyle: true,
                      onToggle: (index) {
                ...
                SizedBox(height: 10,),
                CustomTextFormField(label: "First Name*", labelColor: greyColor2,fieldcontroller: firstNameController,),
                CustomTextFormField(label: "Last Name*", labelColor: greyColor2,fieldcontroller: lastNameController,),
                Padding(
                  padding: const EdgeInsets.only(left: 15),
                  child: Text("Gender", style: TextStyle(fontSize: 16, color: Colors.grey),),
                ),
                Row(
                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                ...
                Padding(
                  ...
                  child: Text("Qualification", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                ...
                Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text("Year of passing", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.only(left: 15,right: 15),
                  child: DropdownButton(
                ...
                CustomTextFormField(label: "Current Address*", labelColor: greyColor2,fieldcontroller:currentAddressController,),
                SizedBox(height: 5,),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 15),
                  child: Text("Preferred Location", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.symmetric(horizontal: 15),
                  child: DropdownButton(
                    ...
                    isExpanded: true,
                    hint: Text("Select prefered location"),
                    // Down Arrow Icon
                    icon: const Icon(Icons.keyboard_arrow_down),
                    // Array list of items
                ...
                Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text("Current CTC", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.only(left: 15,right: 15),
                  child: DropdownButton(
                ...
                Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text("Expected CTC", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null   ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.only(left: 15,right: 15),
                  child: DropdownButton(
                    // Initial Value
                    value:
                    // expected == null || expected == "" ? "4.5 Lakh" :
                    expected,
                    isExpanded: true,
                    hint: Text("Expected CTC"),
                    icon: const Icon(Icons.keyboard_arrow_down),
                    // Array list of items
                ...
                Padding(
                  ...
                  child: Text("Job Type", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: DropdownButton(
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: Text("Designation", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: DropdownButton(
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: Text("Job Role", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: DropdownButton(
                ...
                CustomTextFormField(label: "Key Skills*", labelColor: greyColor2,fieldcontroller: keySkillController,),
                CustomTextFormField(label: "Percentage/CGPA*", labelColor: greyColor2,fieldcontroller: percentageController,),
                SizedBox(height: 5,),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: Text("Years of Experience", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: DropdownButton(
                ...
                Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text("Specialization", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.only(left: 15,right: 15),
                  child: DropdownButton(
                ...
                Padding(
                  padding: EdgeInsets.only(left: 15),
                  child: Text("Notice Period", style: TextStyle(fontWeight: FontWeight.bold, color: greyColor1),),
                ),
                addJobDataModel == null ? Center(child: CircularProgressIndicator(),) :  Padding(
                  padding: EdgeInsets.only(left: 15,right: 15),
                  child: DropdownButton(
