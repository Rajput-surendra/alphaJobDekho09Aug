            ...
            children: [
              ...
              JobCardBottomTile(
                shareOnTap: ()async{
                  ...
                  List<Application> app = await DeviceApps.getInstalledApplications(onlyAppsWithLaunchIntent: true, includeSystemApps: true);
                  Application? app1 = await DeviceApps.getApp('com.alphaJobDekho');
                  bool isInstalled = await DeviceApps.isAppInstalled('com.alphaJobDekho');

                    if(isInstalled){
                      DeviceApps.openApp('com.alphaJobDekho');
                    }
                    else{
                      share();
                    }
